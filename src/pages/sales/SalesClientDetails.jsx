        ...
        <div className="p-6 space-y-10 mt-5">
            ...
            {showPreview && (
                ...
                >
                    ...
                    >
                        <button
                            className="absolute top-2 right-2 bg-black text-white rounded-full w-8 h-8 flex justify-center items-center"
                            onClick={() => setShowPreview(false)}
                        >
                            ✕
                        </button>
            ...
            <div className="mt-2 flex gap-3 flex-wrap">
                ...
                {file && (
                    <img
                        ...
                        className="h-20 w-20 object-cover rounded border cursor-pointer"
                        onClick={() => {
                            setPreviewImage(clean(file.path));
                            setShowPreview(true);
                        }}
                    />
                )}
