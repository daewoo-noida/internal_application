export const personalStateDistricts = {
    "Andhra Pradesh": [
        "Alluri Sitharama Raju", "Anakapalli", "Anantapur", "Annamaya",
        "Bapatla", "Chittoor", "East Godavari", "Eluru", "Guntur",
        "Kadapa", "Kakinada", "Konaseema", "Krishna", "Kurnool",
        "Nandyal", "Nellore", "Palnadu", "Parvathipuram Manyam",
        "Prakasam", "Sri Sathya Sai", "Srikakulam", "Tirupati",
    ...
    "Arunachal Pradesh": [
        ...
        "Lower Siang", "Lower Subansiri", "Namsai", "Papum Pare",
        "Shi Yomi", "Siang", "Tawang", "Tirap", "Upper Siang",
        "Upper Subansiri", "West Kameng", "West Siang"
    ],

    "Assam": [
        "Baksa", "Barpeta", "Bajali", "Biswanath", "Bongaigaon",
    ...
    "Chhattisgarh": [
        ...
        "Bijapur", "Bilaspur", "Dakshin Bastar Dantewada", "Dhamtari",
        "Durg", "Gariaband", "Gaurela-Pendra-Marwahi", "Janjgir-Champa",
        "Jashpur", "Kabeerdham", "Khairagarh-Chhuikhadan-Gandai",
        "Kondagaon", "Korba", "Koriya", "Mahasamund",
        "Manendragarh-Chirmiri-Bharatpur", "Mungeli", "Narayanpur",
    ...
    "Jharkhand": [
        ...
        "Ranchi", "Sahebganj", "Saraikela-Kharsawan",
    ...
    "Madhya Pradesh": [
        ...
        "Morena", "Narsinghpur", "Neemuch", "Niwari", "Panna",
    ...
    "Maharashtra": [
        ...
        "Mumbai Suburban", "Nagpur", "Nanded", "Nandurbar",
    ...
    "Mizoram": [
        ...
        "Kolasib", "Lawngtlai", "Lunglei", "Mamit", "Saiha",
        "Saitual", "Serchhip"
    ],

    "Nagaland": [
        "Chümoukedima", "Dimapur", "Kiphire", "Kohima",
        "Longleng", "Mokokchung", "Mon", "Noklak", "Peren",
    ...
    "Odisha": [
        ...
        "Dhenkanal", "Gajapati", "Ganjam", "Jagatsinghapur",
    ...
    "Punjab": [
        ...
        "Malerkotla", "Mansa", "Moga", "Muktsar", "Pathankot",
        "Patiala", "Rupnagar", "Sangrur", "SAS Nagar",
        "SBS Nagar", "Sri Muktsar Sahib", "Tarn Taran"
    ],

    "Rajasthan": [
        "Ajmer", "Alwar", "Balotra", "Baran", "Barmer",
    ...
    "Uttar Pradesh": [
        ...
        "Pratapgarh", "Prayagraj", "Rae Bareli", "Rampur",
